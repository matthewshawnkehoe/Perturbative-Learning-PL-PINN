...
def train_gpe_model(eta_values, modes, p, X_train, lb, ub, layers,
    ...
    tuple: (models_by_mode, lambda_table, training_history)
        Trained models organized by mode and eta, chemical potential values, and training histories
    """
    ...
    for mode in modes:
        ...
        for eta in eta_values:
            ...
            if verbose:
                print(f"\nTraining for γ = {eta:.2f}, mode = {mode}, nonlinearity p = {p}")
...
if __name__ == "__main__":
    ...
    # eta_values = [k * alpha for k in range(21)]
    ...
    for p in nonlinearity_powers:
        ...
        filename = f"{potential_type}_p{p}_pert_const_{perturb_const}_tol_{tol}_pinn.pkl"

        # Create plotting and model saving directory
        p_save_dir = f"{potential_type}_pinn_simulations_p{p}"
