...
class GrossPitaevskiiPINN(nn.Module):
    ...
    def __init__(self, layers, hbar=1.0, m=1.0, mode=0, eta=1.0, L=1.0, use_residual=True, use_perturbation=True):
        """
        Parameters
        ----------
        layers : list of int
    ...
    def box_eigenfunction(self, x, n):
        ...
        For the linear case (eta = 0), the solution is:
    ...
    def pde_loss(self, inputs, predictions, eta, p, potential_type="box", precomputed_potential=None):
        """
...
def train_gpe_model(eta_values, modes, p, X_train, lb, ub, layers,
    ...
    for mode in modes:
        ...
        for eta in eta_values:
            ...
            model = GrossPitaevskiiPINN(layers, mode=mode, eta=eta, L=L).to(device)
...
def plot_wavefunction(models_by_mode, X_test, eta_values,
    ...
    """
    Plot wavefunctionsfor different modes and eta values.
    """
